 ...
 */
#define READ_INT( szFileName, VarName, myrank)    read_int   ( szFileName, #VarName, &(VarName), myrank) 
 ...
 * READ_STRING( szFile, szProblem );
 */
#define READ_DOUBLE( szFileName, VarName, myrank) read_double( szFileName, #VarName, &(VarName), myrank)
...
void read_int   ( const char* szFilename, const char* szName, int*    nValue, int myrank);
void read_double( const char* szFilename, const char* szName, double*  Value, int myrank);
