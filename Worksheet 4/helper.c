...
void read_int( const char* szFileName, const char* szVarName, int* pVariable, int myrank)
{
...
void read_double( const char* szFileName, const char* szVarName, double* pVariable, int myrank)
{
